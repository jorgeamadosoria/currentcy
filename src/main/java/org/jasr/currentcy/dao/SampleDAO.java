...
public interface SampleDAO {
    /**
     * Returns an entry per exchange containing buy and sell values for each existing currency on the system
     * 
     * @return list of currency snapshots
     */
     ...
     * 
     * @param source
     *            the code for the exchange that is to be sampled
     * @param currency
     *            currency to be sampled from the exchange
     ...
     * 
     * @param currency
     *            currency to get samples for.
     * @return the latest sample for each exchange and the specified currency
     */
    public List<Sample> getSnapshot(Currencies currency);

    /**
     * A list of the latest samples for the specified currency and each exchange with changes on their values since the last
     * sampling.
     * 
     * @param currency
     *            currency to get samples for.
